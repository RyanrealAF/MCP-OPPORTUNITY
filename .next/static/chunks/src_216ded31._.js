...
'use client';
;
class ErrorEmitter extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$events$2f$events$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventEmitter"] {
}
            ...
            const handlePermissionError = {
                "FirebaseErrorListener.useEffect.handlePermissionError": (error)=>{
                    toast({
                        variant: 'destructive',
                        title: 'Access Denied',
                        description: "Security rules blocked ".concat(error.context.operation, " on ").concat(error.context.path, ". Check your permissions.")
                    });
                }
            }["FirebaseErrorListener.useEffect.handlePermissionError"];
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorEmitter"].on('permission-error', handlePermissionError);
            return ({
                "FirebaseErrorListener.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorEmitter"].off('permission-error', handlePermissionError);
                }
            })["FirebaseErrorListener.useEffect"];
        }
    }["FirebaseErrorListener.useEffect"], [
...
_s1(useFirebaseApp, "T9EneGv9JwHIm5MrAsTQ/qK0Zbs=", false, function() {
    return [
        useFirebase
    ];
});
...
_s2(useFirestore, "T9EneGv9JwHIm5MrAsTQ/qK0Zbs=", false, function() {
    return [
        useFirebase
    ];
});
...
_s3(useAuth, "T9EneGv9JwHIm5MrAsTQ/qK0Zbs=", false, function() {
    return [
        useFirebase
    ];
});
...
;
;
const FirebaseClientProvider = (param)=>{
    let { children } = param;
    _s();
    ...
    const instances = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FirebaseClientProvider.useMemo[instances]": ()=>{
            // Return nulls during SSR or before validation
            if (!isMounted || "object" === 'undefined' || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigValid"])()) {
                return {
                    firebaseApp: null,
                    firestore: null,
                    auth: null
            ...
            try {
                ...
                const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuth"])(firebaseApp);
                return {
                    firebaseApp,
                    firestore,
                    auth
...
_s(FirebaseClientProvider, "J1M77kYtVaDwXODrMcd9mxVex/k=");
...
class FirestorePermissionError extends Error {
    constructor(context){
        super("Missing or insufficient permissions for ".concat(context.operation, " at ").concat(context.path)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "context", void 0);
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(query, {
                "useCollection.useEffect.unsubscribe": (snapshot)=>{
                    const docs = snapshot.docs.map({
                        "useCollection.useEffect.unsubscribe.docs": (doc)=>({
                                ...doc.data(),
                                id: doc.id
                            })
                    }["useCollection.useEffect.unsubscribe.docs"]);
                    setData(docs);
                    setLoading(false);
                }
            }["useCollection.useEffect.unsubscribe"], {
                "useCollection.useEffect.unsubscribe": async (err)=>{
                    var __query_path_segments, __query_path, __query;
                    const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                        path: ((__query = query._query) === null || __query === void 0 ? void 0 : (__query_path = __query.path) === null || __query_path === void 0 ? void 0 : (__query_path_segments = __query_path.segments) === null || __query_path_segments === void 0 ? void 0 : __query_path_segments.join('/')) || 'unknown',
                        operation: 'list'
                    });
...
_s(useCollection, "C4fiAW6C7RZgaKDoEXQgZpbuUZg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDoc.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(docRef, {
                ...
                "useDoc.useEffect.unsubscribe": async (err)=>{
                    const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                        path: docRef.path,
                        operation: 'get'
                    });
...
_s(useDoc, "RiL7vLwmC7ZWXKL/bXt2EIBjBYk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function initializeFirebase() {
    if ("object" === 'undefined' || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigValid"])()) {
        return {
            firebaseApp: null,
            firestore: null,
            auth: null
...
//# sourceMappingURL=src_216ded31._.js.map